...
def ColorPair25_GeneratePDF_Manual():
    ...
    colorPair25_table_Axes.table(cellText=cp25_table_text, rowLabels=cp25_table_rows, colLabels=cp25_columns, cellColours=cp25_table_cell_colors, loc='top', bbox=[0,0,1,1])
    ...
    plt.savefig("ColorPair25_PDF_Manual_Generated.pdf",bbox_inches='tight')
    plt.show()